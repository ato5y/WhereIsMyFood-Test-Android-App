...
/**
 * Created by to5y on 16/08/2017.
 */

public class AddOrderAPI extends AsyncTask<String, Void, String> {


    private OnTaskComplete listener;
    private ProgressDialog loginProgress;

    public AddOrderAPI(ProgressDialog loginProgress , OnTaskComplete listener) {
    ...
    protected String doInBackground(String... strings) {
        try
        {
            ...
            json.put("userID", strings[1]);
            json.put("menuIDs",strings[2]);
            json.put("address",strings[3]);
            json.put("longitude",strings[4]);
            json.put("latitude",strings[5]);
